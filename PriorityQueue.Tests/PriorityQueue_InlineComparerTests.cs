...
{
    public class PriorityQueue_InlineComparerTests
    {
        [Fact]
        public static void Simple_Priority_Queue()
        {
            var pq = new PriorityQueue_InlineComparer<string, int>();
        ...
        public static void HeapSort_Should_Work(string[] inputs)
        {
            ...
            {
                var pq = new PriorityQueue_InlineComparer<string, string>();
                ValidateState(pq);
        ...
        public static void HeapSort_Ctor_Should_Work(string[] inputs)
        {
            ...
            static IEnumerable<string> HeapSort(string[] inputs)
            {
                var pq = new PriorityQueue_InlineComparer<string, string>(inputs.Select(x => (x, x)));
        ...
        private static void ValidateState<TElement, TPriority>(PriorityQueue_InlineComparer<TElement, TPriority> pq)
        {
#if DEBUG
