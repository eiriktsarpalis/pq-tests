...
{
    public class PriorityQueueSingleArrayTests
    {
        [Fact]
        public static void Simple_Priority_Queue()
        {
            var pq = new PriorityQueueSingleArray<string, int>();
        ...
        {
            var pq = new PriorityQueueSingleArray<string, int>(new (string, int)[] { ("John", 1940), ("Paul", 1942), ("George", 1943), ("Ringo", 1940) });
        ...
        public static void HeapSort_Should_Work(string[] inputs)
        {
            ...
            {
                var pq = new PriorityQueueSingleArray<string, string>();
                ValidateState(pq);
        ...
        public static void HeapSort_Ctor_Should_Work(string[] inputs)
        {
            ...
            static IEnumerable<string> HeapSort(string[] inputs)
            {
                var pq = new PriorityQueueSingleArray<string, string>(inputs.Select(x => (x, x)));
        ...
        private static void ValidateState<TElement, TPriority>(PriorityQueueSingleArray<TElement, TPriority> pq)
        {
#if DEBUG
